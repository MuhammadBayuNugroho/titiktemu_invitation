...
const config: Config = {
  ...
  plugins: [
    ...
    plugin(function ({ addUtilities }) {
      addUtilities({
        // .glass — only used for badge/small elements (no backdrop-filter, cheap)
        ".glass": {
          backgroundColor: "rgba(255, 255, 255, 0.92)",
          border: "1px solid rgba(26, 26, 46, 0.08)",
          boxShadow: "0 1px 4px rgba(26,26,46,0.06), inset 0 1px 0 rgba(255,255,255,1)",
        },
        ".glass-strong": {
          backgroundColor: "#FFFFFF",
          border: "1px solid rgba(26, 26, 46, 0.08)",
          boxShadow: "0 4px 16px -4px rgba(26,26,46,0.10), 0 1px 4px rgba(26,26,46,0.04)",
        },
        // .glass-subtle — badges and trust pills
        ".glass-subtle": {
          backgroundColor: "rgba(255, 255, 255, 0.85)",
          border: "1px solid rgba(26, 26, 46, 0.07)",
          boxShadow: "0 1px 3px rgba(26,26,46,0.04)",
        },
        // Cards: NO backdrop-filter — solid white + box-shadow (GPU-free)
        ".glass-card": {
          backgroundColor: "#FFFFFF",
          border: "1px solid rgba(26, 26, 46, 0.07)",
          boxShadow: "0 2px 8px rgba(26,26,46,0.05), 0 8px 24px -8px rgba(26,26,46,0.08)",
          borderRadius: "20px",
          transition: "transform 0.30s cubic-bezier(0.16,1,0.3,1), box-shadow 0.30s cubic-bezier(0.16,1,0.3,1)",
        },
        ".glass-card:hover": {
          transform: "translate3d(0, -5px, 0)",
          boxShadow: "0 4px 16px rgba(26,26,46,0.08), 0 20px 40px -12px rgba(26,26,46,0.14)",
        },
        ".glass-card-rose": {
          background: "linear-gradient(135deg, #FFFFFF 0%, rgba(240,213,196,0.35) 100%)",
          border: "1px solid rgba(201, 144, 108, 0.20)",
          boxShadow: "0 2px 8px rgba(26,26,46,0.05), 0 8px 24px -8px rgba(201,144,108,0.18)",
          borderRadius: "20px",
          transition: "transform 0.30s cubic-bezier(0.16,1,0.3,1), box-shadow 0.30s cubic-bezier(0.16,1,0.3,1)",
        },
        ".glass-card-rose:hover": {
          transform: "translate3d(0, -5px, 0)",
          boxShadow: "0 4px 16px rgba(26,26,46,0.08), 0 20px 40px -12px rgba(201,144,108,0.28)",
        },
        ".glass-card-gold": {
          background: "linear-gradient(135deg, #FFFFFF 0%, rgba(240,228,192,0.35) 100%)",
          border: "1px solid rgba(201, 168, 76, 0.22)",
          boxShadow: "0 2px 8px rgba(26,26,46,0.05), 0 8px 24px -8px rgba(201,168,76,0.18)",
          borderRadius: "20px",
          transition: "transform 0.30s cubic-bezier(0.16,1,0.3,1), box-shadow 0.30s cubic-bezier(0.16,1,0.3,1)",
        },
        ".glass-card-gold:hover": {
          transform: "translate3d(0, -5px, 0)",
          boxShadow: "0 4px 16px rgba(26,26,46,0.08), 0 20px 40px -12px rgba(201,168,76,0.28)",
        },
        ".glass-pill": {
